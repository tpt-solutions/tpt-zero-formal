...
[![crates.io](https://img.shields.io/crates/v/out-zero-float.svg)](https://crates.io/crates/out-zero-float)
[![docs.rs](https://docs.rs/out-zero-float/badge.svg)](https://docs.rs/out-zero-float)
[![license](https://img.shields.io/crates/l/out-zero-float.svg)](#license)
...
[`sqrt`]: https://docs.rs/out-zero-float/latest/out_zero_float/fn.sqrt.html
[`exp`]: https://docs.rs/out-zero-float/latest/out_zero_float/fn.exp.html
[`ln`]: https://docs.rs/out-zero-float/latest/out_zero_float/fn.ln.html

## Install

```sh
cargo add out-zero-float
```
